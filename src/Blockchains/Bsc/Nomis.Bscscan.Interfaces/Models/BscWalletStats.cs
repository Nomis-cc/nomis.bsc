...
namespace Nomis.Bscscan.Interfaces.Models
{
    ...
    /// Bsc wallet stats.
    /// </summary>
    public class BscWalletStats :
        IWalletCommonStats<BscTransactionIntervalData>,
        IWalletBalanceStats,
        ...
        IWalletContractStats
    {
        ...
        /// <inheritdoc/>
        [Display(Description = "Wallet balance", GroupName = "BNB")]
        ...
        /// <inheritdoc/>
        [Display(Description = "The movement of funds on the wallet", GroupName = "BNB")]
        public decimal WalletTurnover { get; set; }

        /// <inheritdoc/>
        public IEnumerable<BscTransactionIntervalData>? TurnoverIntervals { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last month", GroupName = "BNB")]
        public decimal BalanceChangeInLastMonth { get; set; }

        /// <inheritdoc/>
        [Display(Description = "The balance change value in the last year", GroupName = "BNB")]
        ...
        /// <inheritdoc/>
        [Display(Description = "NFT trading activity", GroupName = "BNB")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Display(Description = "NFT worth on wallet", GroupName = "BNB")]
        ...
        public Dictionary<string, PropertyData> StatsDescriptions => GetType()
            .GetProperties()
            .Where(prop => !IWalletCommonStats<BscTransactionIntervalData>.ExcludedStatDescriptions.Contains(prop.Name) && Attribute.IsDefined(prop, typeof(DisplayAttribute)))
