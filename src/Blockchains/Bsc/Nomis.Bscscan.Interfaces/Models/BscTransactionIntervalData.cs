// ------------------------------------------------------------------------------------------------------
// <copyright file="BscTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.Bscscan.Interfaces.Models
{
    ...
    public class BscTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToBnb();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToBnb();
        ...
        public decimal AmountInSumValue => AmountInSum.ToBnb();
