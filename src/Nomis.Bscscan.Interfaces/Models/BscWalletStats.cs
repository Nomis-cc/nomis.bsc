...
namespace Nomis.Bscscan.Interfaces.Models
{
        ...
        : IWalletStats
    {
        ...
        /// <inheritdoc/>
        [Description("Wallet balance (BNB)")]
        ...
        /// <inheritdoc/>
        [Description("The movement of funds on the wallet (BNB)")]
        ...
        /// <inheritdoc/>
        [Description("NFT trading activity (BNB)")]
        public decimal NftTrading { get; set; }

        /// <inheritdoc/>
        [Description("NFT worth on wallet (BNB)")]
